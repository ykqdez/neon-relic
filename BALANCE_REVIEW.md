...
生成时间：2026-09-15T22:39:10.236Z。运行 ID：`81894891-a545-4353-a0dd-a660dcd694e1`。
...
本文件由 `node tests/build-report.cjs` 从同次运行结果生成；完整源码 SHA-256 与运行条件见 [CURRENT_BENCHMARK.json](CURRENT_BENCHMARK.json)。父提交为 `e43a156e7a783ce799b16dc29f8d5f24b5f826f7`，测试包含其后的工作区修改。
