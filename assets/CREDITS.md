...
| Digital Audio | [Kenney](https://kenney.nl/assets/digital-audio) | CC0 1.0 | 收录 12 个原始 OGG，用于武器、命中、击杀、拾取、受伤、结算与 Boss 提示；旧升级提示采样不再触发。播放时调整增益和音高。 |
...
使用上表 Digital Audio 和 Thunder 采样，播放时调整音高与增益；基础与进化形态共享对应音色，进化音高降低 15%。
